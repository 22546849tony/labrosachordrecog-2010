...
cut5 = addprefixsuffix(listfileread([listdir,'list2.txt']),'testpool/');
cut6 = addprefixsuffix(listfileread([listdir,'list_4chord.txt']),'4chords/');

ncut1 = [cut2,cut3,cut4];
ncut2 = [cut1,cut3,cut4];
ncut3 = [cut1,cut2,cut4];
ncut4 = [cut1,cut2,cut3];
ncut5 = [cut1,cut2,cut3,cut4];
ncut6 = [cut1,cut2,cut3,cut4,cut5];
...
%       
      extractFeaturesAndTrain_svm(ncut5,scratch, model, ...
                                  mp3dir, mp3ext, labdir, labext, ...
                                  skip, maxframes);
      doChordID_svm(cut5,scratch,results,model,mp3dir,mp3ext,skip);
      
%       extractFeaturesAndTrain_svm(ncut6,scratch, model, ...
%                                   mp3dir, mp3ext, labdir, labext, ...
%                                   skip, maxframes);
%       doChordID_svm(cut6,scratch,results,model,mp3dir,mp3ext,skip);
